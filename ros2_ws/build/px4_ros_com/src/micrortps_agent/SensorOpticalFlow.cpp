...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7c9d8e2
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20d525
    m_timestamp_sample = 0;
    // m_device_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6200f9cb
    m_device_id = 0;
    // m_pixel_flow com.eprosima.idl.parser.typecode.AliasTypeCode@2002fc1d
    memset(&m_pixel_flow, 0, (2) * 4);
    // m_delta_angle com.eprosima.idl.parser.typecode.AliasTypeCode@69453e37
    memset(&m_delta_angle, 0, (3) * 4);
    // m_delta_angle_available com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f4a47c7
    m_delta_angle_available = false;
    // m_distance_m com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ae13544
    m_distance_m = 0.0;
    // m_distance_available com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d34d211
    m_distance_available = false;
    // m_integration_timespan_us com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7dc0f706
    m_integration_timespan_us = 0;
    // m_quality com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4009e306
    m_quality = 0;
    // m_error_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43c1b556
    m_error_count = 0;
    // m_max_flow_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@587e5365
    m_max_flow_rate = 0.0;
    // m_min_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22fcf7ab
    m_min_ground_distance = 0.0;
    // m_max_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de23121
    m_max_ground_distance = 0.0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@63475ace
    m_mode = 0;
