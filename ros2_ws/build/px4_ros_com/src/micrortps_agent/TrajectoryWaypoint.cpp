...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d285d7e
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@40005471
    memset(&m_position, 0, (3) * 4);
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@40005471
    memset(&m_velocity, 0, (3) * 4);
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@40005471
    memset(&m_acceleration, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2cd76f31
    m_yaw = 0.0;
    // m_yaw_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@367ffa75
    m_yaw_speed = 0.0;
    // m_point_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49438269
    m_point_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ba2f4ec
    m_type = 0;
