...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d6f0054
    m_timestamp = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@505fc5a4
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5fbdfdcf
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4efc180e
    m_z = 0.0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@bd4dc25
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25084a1e
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@156b88f5
    m_vz = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@3bf9ce3e
    memset(&m_acceleration, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@3bf9ce3e
    memset(&m_thrust, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@383bfa16
    m_yaw = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d465b11
    m_yawspeed = 0.0;
