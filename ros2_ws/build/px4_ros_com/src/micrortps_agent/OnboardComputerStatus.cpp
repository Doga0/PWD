...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3cfdd820
    m_timestamp = 0;
    // m_uptime com.eprosima.idl.parser.typecode.PrimitiveTypeCode@928763c
    m_uptime = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e25951c
    m_type = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@15f47664
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@471a9022
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@dc9876b
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@471a9022
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f666ebb
    m_temperature_board = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@19976a65
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@a1f72f5
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4b2c5e02
    m_ram_usage = 0;
    // m_ram_total com.eprosima.idl.parser.typecode.PrimitiveTypeCode@57a3e26a
    m_ram_total = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@75c56eb9
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@75c56eb9
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@75c56eb9
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@4bc222e
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@4bc222e
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@4bc222e
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@4bc222e
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@4bc222e
