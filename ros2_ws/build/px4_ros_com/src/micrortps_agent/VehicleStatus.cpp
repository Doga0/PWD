...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5d99c6b5
    m_timestamp = 0;
    // m_nav_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@266374ef
    m_nav_state = 0;
    // m_nav_state_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13b3d178
    m_nav_state_timestamp = 0;
    // m_arming_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24c4ddae
    m_arming_state = 0;
    // m_hil_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37fb0bed
    m_hil_state = 0;
    // m_failsafe com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a82c5f1
    m_failsafe = false;
    // m_failsafe_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b7fdc8
    m_failsafe_timestamp = 0;
    // m_system_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51c693d
    m_system_type = 0;
    // m_system_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a57ae10
    m_system_id = 0;
    // m_component_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@766653e6
    m_component_id = 0;
    // m_vehicle_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e07b95f
    m_vehicle_type = 0;
    // m_is_vtol com.eprosima.idl.parser.typecode.PrimitiveTypeCode@28b46423
    m_is_vtol = false;
    // m_is_vtol_tailsitter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fc4780b
    m_is_vtol_tailsitter = false;
    // m_in_transition_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b79fd76
    m_in_transition_mode = false;
    // m_in_transition_to_fw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@48c76607
    m_in_transition_to_fw = false;
    // m_rc_signal_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43599640
    m_rc_signal_lost = false;
    // m_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1f81aa00
    m_data_link_lost = false;
    // m_data_link_lost_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b6776cb
    m_data_link_lost_counter = 0;
    // m_high_latency_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1863d2fe
    m_high_latency_data_link_lost = false;
    // m_mission_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1787bc24
    m_mission_failure = false;
    // m_geofence_violated com.eprosima.idl.parser.typecode.PrimitiveTypeCode@544d57e
    m_geofence_violated = false;
    // m_failure_detector_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55c53a33
    m_failure_detector_status = 0;
    // m_onboard_control_sensors_present com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53b7f657
    m_onboard_control_sensors_present = 0;
    // m_onboard_control_sensors_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@797b0699
    m_onboard_control_sensors_enabled = 0;
    // m_onboard_control_sensors_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a37d3ed
    m_onboard_control_sensors_health = 0;
    // m_latest_arming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@26df6e3a
    m_latest_arming_reason = 0;
    // m_latest_disarming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4a3631f8
    m_latest_disarming_reason = 0;
    // m_armed_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b58b9e9
    m_armed_time = 0;
    // m_takeoff_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f14a7d4
    m_takeoff_time = 0;
    // m_safety_button_available com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52e7a6b2
    m_safety_button_available = false;
    // m_safety_off com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29a5f4e7
    m_safety_off = false;
