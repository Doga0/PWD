...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6dd7b5a3
    m_timestamp = 0;
    // m_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f3187b0
    m_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2663e964
    m_type = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@48b67364
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@189cbd7c
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7bf3a5d8
    m_vz = 0.0;
    // m_velocity_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42e25b0b
    m_velocity_valid = false;
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@39b43d60
    m_velocity_frame = 0;
    // m_alt_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44be0077
    m_alt_valid = false;
    // m_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2205a05d
    m_lat = 0.0;
    // m_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@72ef8d15
    m_lon = 0.0;
    // m_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6aa8e115
    m_alt = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5e21e98f
    m_yaw = 0.0;
    // m_yaw_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51a9ad5e
    m_yaw_valid = false;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f20155b
    m_yawspeed = 0.0;
    // m_yawspeed_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@72ade7e3
    m_yawspeed_valid = false;
    // m_landing_gear com.eprosima.idl.parser.typecode.PrimitiveTypeCode@239105a8
    m_landing_gear = 0;
    // m_loiter_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3fce8fd9
    m_loiter_radius = 0.0;
    // m_loiter_direction com.eprosima.idl.parser.typecode.PrimitiveTypeCode@609bcfb6
    m_loiter_direction = 0;
    // m_acceptance_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7d94beb9
    m_acceptance_radius = 0.0;
    // m_cruising_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@560348e6
    m_cruising_speed = 0.0;
    // m_cruising_throttle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1df8b5b8
    m_cruising_throttle = 0.0;
    // m_disable_weather_vane com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23202fce
