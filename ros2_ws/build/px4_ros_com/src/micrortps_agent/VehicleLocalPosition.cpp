...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3a44431a
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c7f66c4
    m_timestamp_sample = 0;
    // m_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@194bcebf
    m_xy_valid = false;
    // m_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17497425
    m_z_valid = false;
    // m_v_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f0da945
    m_v_xy_valid = false;
    // m_v_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4803b726
    m_v_z_valid = false;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ffaa6af
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53ce1329
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@316bcf94
    m_z = 0.0;
    // m_delta_xy com.eprosima.idl.parser.typecode.AliasTypeCode@6404f418
    memset(&m_delta_xy, 0, (2) * 4);
    // m_xy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e11f9e9
    m_xy_reset_counter = 0;
    // m_delta_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1de5f259
    m_delta_z = 0.0;
    // m_z_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@729d991e
    m_z_reset_counter = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31fa1761
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@957e06
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32502377
    m_vz = 0.0;
    // m_z_deriv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2c1b194a
    m_z_deriv = 0.0;
    // m_delta_vxy com.eprosima.idl.parser.typecode.AliasTypeCode@6404f418
    memset(&m_delta_vxy, 0, (2) * 4);
    // m_vxy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4dbb42b7
    m_vxy_reset_counter = 0;
    // m_delta_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@66f57048
    m_delta_vz = 0.0;
    // m_vz_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@550dbc7a
    m_vz_reset_counter = 0;
    // m_ax com.eprosima.idl.parser.typecode.PrimitiveTypeCode@21282ed8
    m_ax = 0.0;
    // m_ay com.eprosima.idl.parser.typecode.PrimitiveTypeCode@36916eb0
    m_ay = 0.0;
    // m_az com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7bab3f1a
    m_az = 0.0;
    // m_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@437da279
    m_heading = 0.0;
    // m_delta_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23c30a20
    m_delta_heading = 0.0;
    // m_heading_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e1a0406
    m_heading_reset_counter = 0;
    // m_heading_good_for_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3cebbb30
    m_heading_good_for_control = false;
    // m_xy_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12aba8be
    m_xy_global = false;
    // m_z_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290222c1
    m_z_global = false;
    // m_ref_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67f639d3
    m_ref_timestamp = 0;
    // m_ref_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6253c26
    m_ref_lat = 0.0;
    // m_ref_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49049a04
    m_ref_lon = 0.0;
    // m_ref_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71a8adcf
    m_ref_alt = 0.0;
    // m_dist_bottom com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27462a88
    m_dist_bottom = 0.0;
    // m_dist_bottom_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@82de64a
    m_dist_bottom_valid = false;
    // m_dist_bottom_sensor_bitfield com.eprosima.idl.parser.typecode.PrimitiveTypeCode@659499f1
    m_dist_bottom_sensor_bitfield = 0;
    // m_eph com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51e69659
    m_eph = 0.0;
    // m_epv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@47e2e487
    m_epv = 0.0;
    // m_evh com.eprosima.idl.parser.typecode.PrimitiveTypeCode@201a4587
    m_evh = 0.0;
    // m_evv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61001b64
    m_evv = 0.0;
    // m_vxy_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4310d43
    m_vxy_max = 0.0;
    // m_vz_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@54a7079e
    m_vz_max = 0.0;
    // m_hagl_min com.eprosima.idl.parser.typecode.PrimitiveTypeCode@26e356f0
    m_hagl_min = 0.0;
    // m_hagl_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@47d9a273
    m_hagl_max = 0.0;
