...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6fa34d52
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@57576994
    m_timestamp_sample = 0;
    // m_local_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@616ac46a
    m_local_frame = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67b9b51a
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1205bd62
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7ef27d7f
    m_z = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@490caf5f
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@490caf5f
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@6337c201
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c669da8
    m_velocity_frame = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31920ade
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d483de4
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4032d386
    m_vz = 0.0;
    // m_rollspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@28d18df5
    m_rollspeed = 0.0;
    // m_pitchspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@934b6cb
    m_pitchspeed = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55cf0d14
    m_yawspeed = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@6337c201
    memset(&m_velocity_covariance, 0, (21) * 4);
    // m_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b74ac8
    m_reset_counter = 0;
