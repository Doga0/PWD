...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5b94b04d
    m_timestamp = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@8c3b9d
    m_type = 0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c39bec8
    m_mode = 0;
    // m_flow_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f79e
    m_flow_control = false;
    // m_forwarding com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7ee8290b
    m_forwarding = false;
    // m_mavlink_v2 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1f59a598
    m_mavlink_v2 = false;
    // m_ftp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e178745
    m_ftp = false;
    // m_streams com.eprosima.idl.parser.typecode.PrimitiveTypeCode@192c3f1e
    m_streams = 0;
    // m_data_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@26b3fd41
    m_data_rate = 0.0;
    // m_rate_multiplier com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7494f96a
    m_rate_multiplier = 0.0;
    // m_tx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@561b6512
    m_tx_rate_avg = 0.0;
    // m_tx_error_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e377400
    m_tx_error_rate_avg = 0.0;
    // m_tx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1757cd72
    m_tx_message_count = 0;
    // m_tx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@445b295b
    m_tx_buffer_overruns = 0;
    // m_rx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49e5f737
    m_rx_rate_avg = 0.0;
    // m_rx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c671d7f
    m_rx_message_count = 0;
    // m_rx_message_lost_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@757277dc
    m_rx_message_lost_count = 0;
    // m_rx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@687e99d8
    m_rx_buffer_overruns = 0;
    // m_rx_parse_errors com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e4487af
    m_rx_parse_errors = 0;
    // m_rx_packet_drop_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6aaceffd
    m_rx_packet_drop_count = 0;
    // m_rx_message_lost_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c86b9e3
    m_rx_message_lost_rate = 0.0;
    // m_heartbeat_type_antenna_tracker com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10aa41f2
    m_heartbeat_type_antenna_tracker = false;
    // m_heartbeat_type_gcs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3af9c5b7
    m_heartbeat_type_gcs = false;
    // m_heartbeat_type_onboard_controller com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37271612
    m_heartbeat_type_onboard_controller = false;
    // m_heartbeat_type_gimbal com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ed7f8b4
    m_heartbeat_type_gimbal = false;
    // m_heartbeat_type_adsb com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c309d4d
    m_heartbeat_type_adsb = false;
    // m_heartbeat_type_camera com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38102d01
    m_heartbeat_type_camera = false;
    // m_heartbeat_type_parachute com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37883b97
    m_heartbeat_type_parachute = false;
    // m_heartbeat_component_telemetry_radio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ab778a
    m_heartbeat_component_telemetry_radio = false;
    // m_heartbeat_component_log com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e3958e7
    m_heartbeat_component_log = false;
    // m_heartbeat_component_osd com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77f80c04
    m_heartbeat_component_osd = false;
    // m_heartbeat_component_obstacle_avoidance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dac5ef
    m_heartbeat_component_obstacle_avoidance = false;
    // m_heartbeat_component_vio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c90e579
    m_heartbeat_component_vio = false;
    // m_heartbeat_component_pairing_manager com.eprosima.idl.parser.typecode.PrimitiveTypeCode@58ea606c
    m_heartbeat_component_pairing_manager = false;
    // m_heartbeat_component_udp_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f45df59
    m_heartbeat_component_udp_bridge = false;
    // m_heartbeat_component_uart_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38e79ae3
    m_heartbeat_component_uart_bridge = false;
    // m_avoidance_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@63070bab
    m_avoidance_system_healthy = false;
    // m_parachute_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@68e5eea7
