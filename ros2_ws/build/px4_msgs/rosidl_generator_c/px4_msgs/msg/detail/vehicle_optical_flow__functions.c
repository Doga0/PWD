...
{
  px4_msgs__msg__VehicleOpticalFlow * msg = (px4_msgs__msg__VehicleOpticalFlow *)malloc(sizeof(px4_msgs__msg__VehicleOpticalFlow));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleOpticalFlow__Sequence__init(px4_msgs__msg__VehicleOpticalFlow__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleOpticalFlow *)calloc(size, sizeof(px4_msgs__msg__VehicleOpticalFlow));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleOpticalFlow__Sequence * array = (px4_msgs__msg__VehicleOpticalFlow__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleOpticalFlow__Sequence));
  if (!array) {
    return NULL;
  }
