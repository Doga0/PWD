...
{
  px4_msgs__msg__EstimatorOpticalFlowVel * msg = (px4_msgs__msg__EstimatorOpticalFlowVel *)malloc(sizeof(px4_msgs__msg__EstimatorOpticalFlowVel));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorOpticalFlowVel__Sequence__init(px4_msgs__msg__EstimatorOpticalFlowVel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorOpticalFlowVel *)calloc(size, sizeof(px4_msgs__msg__EstimatorOpticalFlowVel));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__EstimatorOpticalFlowVel__Sequence * array = (px4_msgs__msg__EstimatorOpticalFlowVel__Sequence *)malloc(sizeof(px4_msgs__msg__EstimatorOpticalFlowVel__Sequence));
  if (!array) {
    return NULL;
  }
