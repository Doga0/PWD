...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleStatusFlags_circuit_breaker_flight_termination_disabled circuit_breaker_engaged_airspd_check(::px4_msgs::msg::VehicleStatusFlags::_circuit_breaker_engaged_airspd_check_type arg)
  {
